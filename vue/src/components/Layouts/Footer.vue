<template>
  <div
    class="flex flex-col w-full h-auto font-Montserrat font-semibold text-white"
  >
    <div class="flex w-full py-12 bg-[#26335D]">
      <div
        class="flex flex-col md:flex-row w-full md:max-w-7xl p-6 md:p-0 justify-between py-12 mx-auto"
      >
        <div class="flex flex-col">
          <p class="mb-3">Company Info</p>
          <p>About Us</p>
          <p>Carrier</p>
          <p>We Are Hiring</p>
          <p>Blog</p>
        ...
        <div class="flex flex-col">
          ...
          <p class="flex gap-x-3">
            ...
            >
              ...
              /></svg
            ><span>4517 Washington Ave. Manchester, Kentucy</span>
          </p>
          <p class="flex gap-x-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            >
              ...
              /></svg
            ><span>medicalactive@medic.com</span>
          </p>
        </div>
      </div>
    </div>
    <div class="flex w-full py-3">
      <div class="flex w-3/4 justify-between m-auto text-black">
        <div>
          <p>Medical Active</p>
        </div>
        <div class="flex gap-x-4">
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clip-path="url(#clip0_110_1100)">
              <path
